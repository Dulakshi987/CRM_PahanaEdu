...
<div class="help-container">
    <h2>Billing System - Admin Help Guide</h2>
    ...
    <div class="help-section">
        ...
        <ul class="help-list">
            <li>Navigate to manage customers, items, bills, and users</li>
        </ul>
    </div>

    <div class="help-section">
        <h3>3. Add and manage Customers</h3>
        <p>Go to the "Customers" section and click "Add Customer". Fill in required fields like name, email, contact number, and address. Submit the form to save.</p>
    </div>

    <div class="help-section">
        <h3>4. Managing Items</h3>
        <p>In the "Items" section you can:</p>
        <ul class="help-list">
            <li>Add new items with item code, name, description, price, quantity, and status</li>
            <li>Edit existing item details</li>
            <li>Delete items no longer available</li>
        </ul>
    </div>

    <div class="help-section">
        <h3>5. Generating Bills</h3>
    ...
    <div class="help-section">
        ...
        <p>Admins can add, edit, or delete system users, assign roles such as admin or cashier.</p>
    </div>
    ...
    <div class="help-section">
        <h3>8. Troubleshooting & Support</h3>
